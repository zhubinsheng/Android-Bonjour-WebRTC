...
public class PeerConnectionClient {
  ...
  public void createPeerConnection(final List<VideoSink> remoteSinks, final VideoCapturer videoCapturer, final SignalingParameters signalingParameters) {
  ...
  private boolean isVideoCallEnabled() {
    return /*peerConnectionParameters.videoCallEnabled && videoCapturer != null*/true;
  }
